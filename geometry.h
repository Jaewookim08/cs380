...
public:
    ...
    void setGlVertexAttribPointer(int attribIndex, int glAttribLocation) const {
        ...
        glVertexAttribPointer(glAttribLocation, ad.size, ad.type, ad.normalized, vertexSize_,
                              reinterpret_cast<const GLvoid*>(ad.offset));
    }
...
struct VertexPNTBX : public VertexPNX {
    ...
    VertexPNTBX(const Cvec3& pos, const Cvec3& normal,
            ...
            : VertexPNX(pos, normal, texCoords), t(tangent[0], tangent[1], tangent[2]),
              b(binormal[0], binormal[1], binormal[2]) {}
